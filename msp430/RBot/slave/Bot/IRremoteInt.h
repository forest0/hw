...
// #define GREE_HZ          38    // carrier frequency
// #define GREE_BITS        68    // The number of bits in the command
// #define GREE_HDR_MARK    4500  // The length of the Header:Mark
// #define GREE_HDR_SPACE   9000  // The lenght of the Header:Space
// #define GREE_ONE_MARK    1600  // The length of a Bit:Space for 1's
// #define GREE_ZERO_MARK   600   // The length of a Bit:Space for 0's
// #define GREE_BIT_SPACE   600   // The length of a Bit:Space, same for 0 and 1
// #define GREE_CONT_MARK   20000 // The lenght of the Continue:Mark
// #define GREE_CONT_SPACE  600   // The lenght of the Continue:Space

#define GREE_HZ          38    // carrier frequency
#define GREE_BITS        68    // The number of bits in the command
#define GREE_HDR_MARK    9000  // The length of the Header:Mark
#define GREE_HDR_SPACE   4500  // The lenght of the Header:Space
#define GREE_BIT_MARK    600   // The length of a Bit:Space for 1's
#define GREE_ZERO_SPACE  600   // The length of a Bit:Space for 0's
#define GREE_ONE_SPACE   1600  // The length of a Bit:Space, same for 0 and 1
#define GREE_CONT_MARK   600   // The lenght of the Continue:Mark
#define GREE_CONT_SPACE  20000 // The lenght of the Continue:Space
