...
void IRsend::sendGree(unsigned long beginningHalfPart, unsigned long endingHalfPart) {
    ...
    // Next 3 bit, which is always 010
    mark (GREE_BIT_MARK);
    space(GREE_ZERO_SPACE);
...
/* TODO: <2018-06-05, forest9643, implemen it> */
long IRrecv::decodeGree(decode_results *results) {
    return NULL;
}
