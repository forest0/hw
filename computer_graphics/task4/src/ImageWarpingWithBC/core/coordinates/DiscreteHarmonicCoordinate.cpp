#include "DiscreteHarmonicCoordinate.h"
#include "../model/Triangle.h"
#include "../../utils/Constants.h"
#include "../../utils/Utils.h"

DiscreteHarmonicCoordinate::DiscreteHarmonicCoordinate(
...
std::vector<double> DiscreteHarmonicCoordinate::getCoordinateOf(
...
QPoint DiscreteHarmonicCoordinate::getRealCoordinateOf(
...
double DiscreteHarmonicCoordinate::gernateFunction(double r) const {
